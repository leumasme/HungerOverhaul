...
public class ModuleNatura {
    ...
    public static void init() {
        ...
        if (IguanaConfig.modifyFoodValues && IguanaConfig.useHOFoodValues) {
            ...
            for (int i = 0; i < 4; i++) FoodModifier
                    .setModifiedFoodValues(new ItemStack(NContent.netherBerryItem, 1, i), new FoodValues(1, 0.1F));
        ...
        PlantGrowthModification saguaroGrowthModification = new PlantGrowthModification().setNeedsSunlight(false)
        ...
        PlantGrowthModification berryBushGrowthModification = new PlantGrowthModification().setNeedsSunlight(true)
                .setGrowthTickProbability(IguanaConfig.cropRegrowthMultiplier).setBiomeGrowthModifier(Type.FOREST, 1)
                .setBiomeGrowthModifier(Type.PLAINS, 1);
        ModulePlantGrowth.registerPlantGrowthModifier(BerryBush.class, berryBushGrowthModification);

        PlantGrowthModification netherBushGrowthModification = new PlantGrowthModification().setNeedsSunlight(false)
                .setGrowthTickProbability(IguanaConfig.cropRegrowthMultiplier).setBiomeGrowthModifier(Type.NETHER, 1);
