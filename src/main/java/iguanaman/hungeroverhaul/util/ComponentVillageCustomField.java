...
public class ComponentVillageCustomField extends StructureVillagePieces.Village {
    ...
    public ComponentVillageCustomField(Start par1ComponentVillageStartPiece, int par2, Random par3Random,
    ...
    private Block getRandomCropHarvestCraft(Random random) {
        ...
        return random.nextInt(length + 3) <= length ? PamsModsHelper.PamCrops[random.nextInt(length)]
    ...
    public static ComponentVillageCustomField buildComponent(Start par0Start, List par1List, Random par2Random,
    ...
    public boolean addComponentParts(World par1World, Random par2Random,
        ...
        // FILLER
        for (int var4 = 0; var4 < 9; ++var4) for (int var5 = 0; var5 < 13; ++var5) {
    ...
    private void placeCropAtCurrentPosition(World world, Block block, int meta, int offsetX, int offsetY, int offsetZ,
    ...
    private void placeHarvestCraftCropAtCurrentPosition(World world, Block block, int meta, int offsetX, int offsetY,
            int offsetZ, StructureBoundingBox box) {
