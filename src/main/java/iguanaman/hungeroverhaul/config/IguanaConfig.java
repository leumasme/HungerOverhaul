...
public class IguanaConfig {
    ...
    public static final ConfigCategory CATEGORY_GETTING_SEEDS = addCategory(
            "getting seeds",
            "Options for obtaining seeds");
    public static final ConfigCategory CATEGORY_DELAYS = addCategory(
            "delays",
            "Delays for various obtaining food related activities");
    public static final ConfigCategory CATEGORY_HARVESTING = addCategory(
            "harvesting",
            "Options related to drops from crops");
    public static final ConfigCategory CATEGORY_CUSTOM_FIELD = addCategory(
            "custom field",
    ...
    public static final ConfigCategory CATEGORY_LOW_STATS = addCategory(
            "low stats",
    ...
    public static <T> ConfigOption<T> addOption(ConfigCategory category, String name, T defaultValue, T blankSlate,
            String comment) {
        return addOption(category, name, defaultValue, null, null, blankSlate, comment);
    }

    public static <T> ConfigOption<T> addOption(ConfigCategory category, String name, T defaultValue, T minValue,
            T maxValue, T blankSlate, String comment) {
    ...
    public static <T> ConfigOption<T> putOptionInList(ConfigCategory category, String name, T defaultValue, T minValue,
            T maxValue, T blankSlate, String comment, List<ConfigOption<?>> list) {
        ConfigOption<T> configOption = new ConfigOption<T>(
                category.name,
                name,
                defaultValue,
                minValue,
    ...
    // village field
    public static final ConfigOption<Boolean> addCustomVillageFieldOption = addOption(
            CATEGORY_CUSTOM_FIELD,
            "addCustomVillageField",
            true,
            false,
    ...
    // food
    public static final ConfigOption<Boolean> modifyFoodValuesOption = addOption(
            CATEGORY_FOOD,
            "modifyFoodValues",
            true,
            false,
    ...
    @Deprecated
    public static final ConfigOption<Float> modFoodValueDividerOption = removeOption(
            CATEGORY_FOOD,
            "modFoodValueDivider",
            4.0f);
    @Deprecated
    ...
    // hunger
    public static final ConfigOption<Boolean> constantHungerLossOption = addOption(
            CATEGORY_HUNGER,
            "constantHungerLoss",
            true,
            false,
    ...
    public static final ConfigOption<Integer> damageOnStarveOption = addOption(
            CATEGORY_HUNGER,
            "damageOnStarve",
            200,
            2,
            "Amount of damage you take when hunger hits zero");
    ...
    // low stat
    public static final ConfigOption<Boolean> addGuiTextOption = addOption(
            CATEGORY_LOW_STATS,
            "addGuiText",
            true,
            false,
    ...
    // health
    public static final ConfigOption<Integer> minHungerToHealOption = addOption(
            CATEGORY_HEALTH,
            "minHungerToHeal",
            7,
            0,
            null,
            18,
            "Minimum hunger level before healing starts");
    public static int minHungerToHeal;
    public static final ConfigOption<Boolean> foodRegensHealthOption = addOption(
            CATEGORY_HEALTH,
            "foodRegensHealth",
            false,
            false,
    ...
    @Deprecated
    public static final ConfigOption<Boolean> addSetHungerCommand = removeOption(
            CATEGORY_HUNGER,
            "addSetHungerCommand",
            true);
    @Deprecated
    public static final ConfigOption<Boolean> addSleepHungerLoss = removeOption(
            CATEGORY_HUNGER,
            "addSleepHungerLoss",
            false);
    @Deprecated
    public static final ConfigOption<Boolean> difficultyScalingSleepHungerLoss = removeOption(
            CATEGORY_DIFFICULTY_SCALING,
            "difficultyScalingSleepHungerLoss",
            true);
    @Deprecated
    public static final ConfigOption<Boolean> addLowStatNauseaOption = removeOption(
            CATEGORY_LOW_STATS,
            "addLowStatNausea",
            true);
    @Deprecated
    public static final ConfigOption<Boolean> addLowStatSlownessOption = removeOption(
            CATEGORY_LOW_STATS,
            "addLowStatSlowness",
            true);
    @Deprecated
    public static final ConfigOption<Boolean> addLowStatWeaknessOption = removeOption(
            CATEGORY_LOW_STATS,
            "addLowStatWeakness",
            true);
    @Deprecated
    public static final ConfigOption<Boolean> addLowStatMiningSlowdownOption = removeOption(
            CATEGORY_LOW_STATS,
            "addLowStatMiningSlowdown",
            true);
    @Deprecated
    public static final ConfigOption<Integer> seedsPerHarvestMinOption = removeOption(
            CATEGORY_HARVESTING,
            "seedsPerHarvestMin",
            0);
    @Deprecated
    ...
    @Deprecated
    public static final ConfigOption<Integer> seedsPerHarvestMaxOption = removeOption(
            CATEGORY_HARVESTING,
            "seedsPerHarvestMax",
            0);
    @Deprecated
    ...
    @Deprecated
    public static final ConfigOption<Integer> producePerHarvestMinOption = removeOption(
            CATEGORY_HARVESTING,
            "producePerHarvestMin",
            2);
    @Deprecated
    public static int producePerHarvestMin;
    @Deprecated
    public static final ConfigOption<Integer> producePerHarvestMaxOption = removeOption(
            CATEGORY_HARVESTING,
            "producePerHarvestMax",
            4);
    @Deprecated
    public static int producePerHarvestMax;
    @Deprecated
    public static final ConfigOption<Boolean> modifyCropDropsOption = removeOption(
            CATEGORY_HARVESTING,
            "modifyCropDrops",
            true);
    @Deprecated
    ...
    public static void reload(Configuration config) {
        ...
        modifyCropDropsRightClick = modifyCropDropsRightClickOption
                .getBackwardsCompatible(config, modifyCropDropsOption);
        modifyCropDrops = modifyCropDropsBreak;
        seedsPerHarvestRightClickMin = seedsPerHarvestRightClickMinOption
                .getBackwardsCompatible(config, seedsPerHarvestMinOption);
        seedsPerHarvestRightClickMax = seedsPerHarvestRightClickMaxOption
                .getBackwardsCompatible(config, seedsPerHarvestMaxOption);
        seedsPerHarvestBreakMin = seedsPerHarvestBreakMinOption
                .getBackwardsCompatible(config, seedsPerHarvestMinOption);
        seedsPerHarvestBreakMax = seedsPerHarvestBreakMaxOption
                .getBackwardsCompatible(config, seedsPerHarvestMaxOption);
        seedsPerHarvestMin = seedsPerHarvestRightClickMin;
        seedsPerHarvestMax = seedsPerHarvestRightClickMax;
        producePerHarvestRightClickMin = producePerHarvestRightClickMinOption
                .getBackwardsCompatible(config, producePerHarvestMinOption);
        producePerHarvestRightClickMax = producePerHarvestRightClickMaxOption
                .getBackwardsCompatible(config, producePerHarvestMaxOption);
        producePerHarvestBreakMin = producePerHarvestBreakMinOption
                .getBackwardsCompatible(config, producePerHarvestMinOption);
        producePerHarvestBreakMax = producePerHarvestBreakMaxOption
                .getBackwardsCompatible(config, producePerHarvestMaxOption);
        ...
        modifyBonemealGrowth = modifyBonemealGrowthOption
                .getBackwardsCompatible(config, difficultyScalingBoneMealOption);
        ...
        addLowHealthMiningSlowdown = addLowHealthMiningSlowdownOption
                .getBackwardsCompatible(config, addLowStatMiningSlowdownOption);
        addLowHungerMiningSlowdown = addLowHungerMiningSlowdownOption
                .getBackwardsCompatible(config, addLowStatMiningSlowdownOption);
